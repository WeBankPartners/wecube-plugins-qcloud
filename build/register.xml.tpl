        ...
        <plugin name="peering-connection" targetPackage="wecmdb" targetEntity="network_zone_link">
            <interface action="create" path="/qcloud/v1/peering-connection/create">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:network_zone_link.network_zone_2>wecmdb:network_zone.data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:network_zone_link.network_zone_1>wecmdb:network_zone.data_center>wecmdb:data_center.NONE" required="N">peer_provider_params</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:network_zone_link.network_zone_1>wecmdb:network_zone.vpc_asset_code" required="Y">peer_vpc_id</parameter>
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_UID" required="Y">peer_uin</parameter>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:network_zone_link.network_zone_2>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:network_zone_link.network_zone_1>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">peer_location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="security-group" targetPackage="wecmdb" targetEntity="unit" registerName="unit">
            <interface action="create" path="/qcloud/v1/security-group/create">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:unit.subsys>wecmdb:subsys.system>wecmdb:system.region_data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:unit.subsys>wecmdb:subsys.system>wecmdb:system.region_data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="security-policy" targetPackage="wecmdb" targetEntity="default_security_policy" registerName="vpc_network_zone">
            <interface action="create-policies" path="/qcloud/v1/security-policy/create-policies">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:default_security_policy.vpc_network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="security-policy" targetPackage="wecmdb" targetEntity="direct_service_invoke" registerName="unit_ingress">
            <interface action="create-policies" path="/qcloud/v1/security-policy/create-policies">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:direct_service_invoke.invoked_unit>wecmdb:unit.subsys>wecmdb:subsys.system>wecmdb:system.data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:direct_service_invoke.invoked_unit>wecmdb:unit.subsys>wecmdb:subsys.system>wecmdb:system.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="security-policy" targetPackage="wecmdb" targetEntity="invoke" registerName="unit_egress">
            <interface action="create-policies" path="/qcloud/v1/security-policy/create-policies">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:invoke.invoke_unit>wecmdb:unit.subsys>wecmdb:subsys.system>wecmdb:system.data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:invoke.invoke_unit>wecmdb:unit.subsys>wecmdb:subsys.system>wecmdb:system.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="route-table" targetPackage="wecmdb" targetEntity="resource_set">
            <interface action="create" path="/qcloud/v1/route-table/create">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:resource_set.business_zone>wecmdb:business_zone.network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:resource_set.business_zone>wecmdb:business_zone.network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="vm" targetPackage="wecmdb" targetEntity="resource_instance">
            <interface action="create" path="/qcloud/v1/vm/create">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:resource_instance.resource_set>wecmdb:resource_set.business_zone>wecmdb:business_zone.network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:resource_instance.resource_set>wecmdb:resource_set.business_zone>wecmdb:business_zone.network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="storage" targetPackage="wecmdb" targetEntity="block_storage">          
	        <interface action="buy-and-mount-cbs-disk" path="/qcloud/v1/cbs/create-mount">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:block_storage.resource_instance>wecmdb:resource_instance.resource_set>wecmdb:resource_set.business_zone>wecmdb:business_zone.network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="route-policy" targetPackage="wecmdb" targetEntity="routing_rule" registerName="network_zone">
            <interface action="create" path="/qcloud/v1/route-policy/create">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.owner_vpc_network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.owner_vpc_network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
        ...
        <plugin name="route-policy" targetPackage="wecmdb" targetEntity="routing_rule" registerName="resource_set">
            <interface action="create" path="/qcloud/v1/route-policy/create">
                <inputParameters>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.id" required="Y">guid</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.asset_code" required="N">id</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.owner_resource_set>wecmdb:resource_set.business_zone>wecmdb:business_zone.network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.NONE" required="N">provider_params</parameter>
                    ...
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.description" required="N">desc</parameter>
                    <parameter datatype="string" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET" required="Y">api_secret</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.owner_resource_set>wecmdb:resource_set.business_zone>wecmdb:business_zone.network_zone>wecmdb:network_zone.data_center>wecmdb:data_center.location" required="Y">location</parameter>
                </inputParameters>
                <outputParameters>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.id">guid</parameter>
                    <parameter datatype="string" mappingType="entity" mappingEntityExpression="wecmdb:routing_rule.asset_code">id</parameter>
