        ...
        <plugin name="storage" targetPackage="wecmdb" targetEntity="block_storage">
            <interface action="create" path="/qcloud/v1/storage/create">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType='entity' required="N">disk_charge_period</parameter>
        ...
        <plugin name="mysql" targetPackage="wecmdb" targetEntity="resource_instance">
            <interface action="create" path="/qcloud/v1/mysql/create">
                <inputParameters>
                    ...
                    <parameter datatype="string" mappingType="entity" required="N">master_region</parameter>
                    <parameter datatype="string" mappingType="entity" required="N">master_instance_id</parameter>
