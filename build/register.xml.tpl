...
<package name="qcloud" version="{{PLUGIN_VERSION}}">
    ...
    <plugins>
            ...
            <plugin name="vm" targetPackage="" targetEntity="" registerName="" targetEntityFilterRule="">
                ...
                <interface action="bind-security-group-to-vm" path="/qcloud/v1/vm/bind-security-groups" filterRule="">
                    <inputParameters>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="">guid</parameter>
                        <parameter datatype="string" required="N" sensitiveData="Y" mappingType="entity" mappingEntityExpression="">provider_params</parameter>
            ...
            <plugin name="peering-connection" targetPackage="wecmdb" targetEntity="network_link" registerName="network_link" targetEntityFilterRule="{network_link_type eq 'PEERCONNECTION'}">
            ...
            <plugin name="security-group" targetPackage="wecmdb" targetEntity="network_segment" registerName="vpc" targetEntityFilterRule="{network_segment_usage eq 'VPC'}">
                <interface action="create" path="/qcloud/v1/security-group/create" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_segment.guid">guid</parameter>
                        <parameter datatype="string" required="N" sensitiveData="Y" mappingType="entity" mappingEntityExpression="wecmdb:network_segment.NONE">provider_params</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_segment.name">name</parameter>
            ...
            <plugin name="vm" targetPackage="wecmdb" targetEntity="host_resource_instance" registerName="resource" targetEntityFilterRule="">
                <interface action="create" path="/qcloud/v1/vm/create" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        ...
                        <parameter datatype="string" required="N" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:host_resource_instance.intranet_ip>wecmdb:ip_address.code">instance_private_ip</parameter>
                    ...
                    <outputParameters>
                        ...
                        <parameter datatype="string" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:host_resource_instance.intranet_ip>wecmdb:ip_address.code">instance_private_ip</parameter>
                        <parameter datatype="string" sensitiveData="N" mappingType="context">errorCode</parameter>
                        <parameter datatype="string" sensitiveData="N" mappingType="context">errorMessage</parameter>
    	        </outputParameters>
                </interface>
            ...
            <plugin name="storage" targetPackage="wecmdb" targetEntity="block_storage" registerName="block_storage" targetEntityFilterRule="">
    	        <interface action="buy-and-mount-cbs-disk" path="/qcloud/v1/cbs/create-mount" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="Y" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET">api_secret</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:block_storage.host_resource_instance>wecmdb:host_resource_instance.intranet_ip>wecmdb:ip_address.network_segment>wecmdb:network_segment.data_center>wecmdb:data_center.location">location</parameter>
                    </inputParameters>
                    <outputParameters>
            ...
            <plugin name="nat-gateway" targetPackage="wecmdb" targetEntity="network_link" registerName="network_link" targetEntityFilterRule="{network_link_type eq 'NAT'}">
                <interface action="create" path="/qcloud/v1/nat-gateway/create" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_link.network_zone_2>wecmdb:network_zone.network_segment>wecmdb:network_segment.vpc_asset_id">vpc_id</parameter>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_link.netband_width">bandwidth</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="Y" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET">api_secret</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_link.network_zone_2>wecmdb:network_zone.data_center>wecmdb:data_center.location">location</parameter>
                    </inputParameters>
                    <outputParameters>
                        <parameter datatype="string" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_link.guid">guid</parameter>
                        <parameter datatype="string" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_link.asset_id">id</parameter>
                         <!--待测试-->
                        <parameter datatype="string" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_link.internet_ip>wecmdb:ip_address.code">eip</parameter>
                        <parameter datatype="string" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:network_link.internet_ip>wecmdb:ip_address.asset_id">eip_id</parameter>
                         <!--待测试-->
                        <parameter datatype="string" sensitiveData="N" mappingType="context">errorCode</parameter>
                        <parameter datatype="string" sensitiveData="N" mappingType="context">errorMessage</parameter>
    	        </outputParameters>
            ...
            <plugin name="mysql" targetPackage="wecmdb" targetEntity="rdb_resource_instance" registerName="resource" targetEntityFilterRule="">
                <interface action="create" path="/qcloud/v1/mysql/create" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="Y" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET">api_secret</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:rdb_resource_instance.intranet_ip>wecmdb:ip_address.network_segment>wecmdb:network_segment.data_center>wecmdb:data_center.location">location</parameter>
                    </inputParameters>
                    <outputParameters>
                ...
                <interface action="bind-security-group" path="/qcloud/v1/mysql/bind-security-group" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:rdb_resource_instance.guid">guid</parameter>
                        <parameter datatype="string" required="N" sensitiveData="Y" mappingType="entity" mappingEntityExpression="wecmdb:rdb_resource_instance.NONE">provider_params</parameter>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:rdb_resource_instance.intranet_ip>wecmdb:ip_address.network_segment>wecmdb:network_segment.f_network_segment>wecmdb:network_segment.security_group_asset_id">security_group_ids</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="Y" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET">api_secret</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:rdb_resource_instance.intranet_ip>wecmdb:ip_address.network_segment>wecmdb:network_segment.data_center>wecmdb:data_center.location">location</parameter>
                    </inputParameters>
                    <outputParameters>
            ...
            <plugin name="clb" targetPackage="wecmdb" targetEntity="lb_resource_instance" registerName="resource" targetEntityFilterRule="">
                <interface action="create" path="/qcloud/v1/clb/create" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        ...
                        <parameter datatype="string" required="N" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:lb_resource_instance.name">name</parameter>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:lb_resource_instance.ip_address>wecmdb:ip_address.network_segment>wecmdb:network_segment.f_network_segment>wecmdb:network_segment.vpc_asset_id">vpc_id</parameter>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="Y" mappingType="system_variable" mappingSystemVariableName="QCLOUD_API_SECRET">api_secret</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:lb_resource_instance.ip_address>wecmdb:ip_address.network_segment>wecmdb:network_segment.data_center>wecmdb:data_center.location">location</parameter>
                    </inputParameters>
                    <outputParameters>
            ...
            <plugin name="clb-target" targetPackage="wecmdb" targetEntity="lb_instance" registerName="app" targetEntityFilterRule="">
                <interface action="add-backtarget" path="/qcloud/v1/clb-target/add-backtarget" filterRule="{state_code eq 'created'}{fixed_date is NULL}">
                    <inputParameters>
                        ...
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:lb_instance.unit>wecmdb:unit.unit_design>wecmdb:unit_design.protocol">protocol</parameter>
                ...
                <interface action="del-backtarget" path="/qcloud/v1/clb-target/del-backtarget" filterRule="{state_code eq 'destroyed'}{fixed_date is NULL}">
                    <inputParameters>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:lb_instance.guid">guid</parameter>
                        <parameter datatype="string" required="N" sensitiveData="Y" mappingType="entity" mappingEntityExpression="wecmdb:lb_instance.NONE">provider_params</parameter>
                        <parameter datatype="string" required="Y" sensitiveData="N" mappingType="entity" mappingEntityExpression="wecmdb:lb_instance.lb_resource_instance>wecmdb:lb_resource_instance.asset_id">lb_id</parameter>
