...
import (
	...
	mongodb "github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/redis/v20180408"
)
...
func createMongodbClient(providerParams string) (client *redis.Client, err error) {
...
func queryMongodbInstances(providerParams string,offset uint64,limit uint64)([]*mongodb.MongoDBInstanceDetail,uint64,error){
	...
	return resp.Response.InstanceDetails,nil 
}
...
func (instance MongodbInstance)QuerySecurityGroups(providerParams string) ([]string, error){
	return []string{},fmt.Errrorf("mongodb do not support query security group api")
}

func (instance MongodbInstance)AssociateSecurityGroups(providerParams string, securityGroups []string) error{
	return fmt.Errrorf("mongodb do not support associateSecurityGroup api")
}
